  ...
  return (
    <>
      ...
      <div className="sa-widget">
        {/* Toggle button */}
        <button className="sa-toggle" onClick={() => { const s = !isOpen; setIsOpen(s); window.parent.postMessage(s ? 'open' : 'close', '*'); }} aria-label="Apri assistente virtuale">
          {isOpen ? (
        ...
        {isOpen && (
          <div className="sa-panel">
            ...
            <div className="sa-header">
              ...
              <button className="sa-close" onClick={() => { setIsOpen(false); window.parent.postMessage('close', '*'); }}>
